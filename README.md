...
[
  {
    "epoch": 985,
    "claimant": "GEM1N1UE3C8BB8EaaEPrcFvT3iLMVrurknjW5AYjUReR",
    "amount_lamports": 1054104006,
    "recent_blockhash": "FnH5jCk4BJREqGQ2opQM9wxGLDEdKQoCQBTxYTV14nqK",
    "uses_nonce": false,
    "assert_deploy_slot": 396979600,
...
- name: Hand each unsigned tx to the signer
...
| `--first-epoch <epoch>` | No (default: 912) | First epoch to scan in scan-all mode (when `--epoch` omitted) |
